...
(spots, faculae) on the stellar surface.
...
- `GitHub Repository <https://github.com/SamMerc/sajax>`_
- `Report Issues <https://github.com/SamMerc/sajax/issues>`_
- `View on PyPI <https://pypi.org/project/sajax/>`_
